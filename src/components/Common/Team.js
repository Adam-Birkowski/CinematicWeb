...
const members =[
    {name:'Ferdek',role:'TeamLeader', image: img1},
    {name:'Halinka',role:'Support', image: img3},
    {name:'Cycu',role:'Lead Developer', image: img2},
            ...
            <section className="page-section bg-light" id="team">
                <div className="container">
                    <div className="text-center">
                        ...
                        <h3 className="section-subheading text-muted">The Kiepscy</h3>
                    </div>
                    <div className="row">
